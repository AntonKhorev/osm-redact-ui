...
import AuthNewStage from './stages/auth/new/auth-new-stage'
import AuthNewAnonymousStage from './stages/auth/new/auth-new-anonymous-stage'
import AuthNewTokenStage from './stages/auth/new/auth-new-token-stage'
import AuthNewManualGrantStage from './stages/auth/new/auth-new-manual-grant-stage'
import AuthNewAutoGrantStage from './stages/auth/new/auth-new-auto-grant-stage'
...
import InputOsmUrlProvider from './stages/auth/new/input-osm-url-provider'
import FixedOsmUrlProvider from './stages/auth/new/fixed-osm-url-provider'
import InputOsmClientIdProvider from './stages/auth/new/input-osm-client-id-provider'
import FixedOsmClientIdProvider from './stages/auth/new/fixed-osm-client-id-provider'
